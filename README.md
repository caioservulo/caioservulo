...
* **[Case 01: Otimização de Retenção (Churn)](./cases/retencao-churn.md)**
    * *Impacto:* Redução de 15% no churn mensal através de modelos de Data Science.
...
| :--- | :--- |
| **Gestão & Roadmap** | `Jira`, `Miro`, `Productboard` |
| **Análise de Dados** | `SQL`, `Tableau`, `Power BI`, `Python` |
| **Frameworks** | `Scrum`, `Kanban`, `Jobs to be Done`, `OKRs` |
